...
describe('research export builder', () => {
    it('builds the full research archive dataset with the 1.3.0 file set', async () => {
        ...
        expect(exportBundle.reportHtml).toContain('grid-template-columns: minmax(0, 1fr) auto minmax(0, 1fr);');
        ...
        expect(exportBundle.reportHtml).toContain('report-print-footer-page');
        ...
        expect(exportBundle.reportHtml).toContain('bottom: 8mm;');
